...
function lakukanLooping(arrPegawai) {
  ...
  */
  for (const pegawai of arrPegawai) {
    const {namaDepan, namaBelakang, jenisKelamin} = pegawai;
    
    hasilLooping.push(`${namaDepan} ${namaBelakang}`);
    
    jenisKelamin === 'F'? jumlahWanita++ : jumlahPria++
  }
  ...
  if (jumlahPria < jumlahWanita) { komentar = 'Jumlah Wanita lebih banyak dari Pria'; }
